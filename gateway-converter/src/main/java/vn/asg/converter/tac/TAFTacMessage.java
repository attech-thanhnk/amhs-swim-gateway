...
public class TAFTacMessage extends TacMessageImpl {
    ...
    /**
     * Performs parsing message applying regexps step-by-step, truncating processed groups from message
     *
    ...
    public void parseMessage() throws TAFParsingException {
        ...
        if (matcher.lookingAt()) {
            ...
            throw new TAFParsingException(String.format("TAF mandatory header section is missed. [%s]", tac));
        }
    ...
    /**
     * Method for parsing the common weather section that may exists in TAF itself or its trend sections
     */
    protected StringBuffer processCommonWeatherSection(StringBuffer tac) throws TAFParsingException {
        try {
            ...
            throw new TAFParsingException(ex.getMessage() + " in [" + CoreUtil.truncateString(this.getInitialTacString(), 25) + "]", ex);
        }
        ...
        while (matcher.find()) {
            ...
            switch (sec) {
                ...
                case FM:
                    ...
                    timeSec.setSectionType(ForecastSectionType.FM);
                    break;
                case TL:
    ...
    public String getIdentifier() {
        return String.format("TAF_%s_%s.xml",
                this.getIcaoCode(),

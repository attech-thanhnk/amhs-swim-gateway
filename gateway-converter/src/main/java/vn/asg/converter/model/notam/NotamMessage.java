package vn.asg.converter.model.notam;

import vn.asg.converter.model.BaseMessage;
import org.joda.time.DateTime;

public class NotamMessage extends BaseMessage {
    ...
    public String getLowerHeight() {
        return lowerHeight;
    }

    public void setLowerHeight(String lowerHeight) {
    ...
    public String toString() {
        ...
        sb.append(" ").append(getMessageType() != null && !getMessageType().isEmpty() ? getMessageType() : "NOTAMN").append("\n");
    ...
    public void validate() throws Exception {
        if (notamId == null || notamId.isEmpty()) throw new Exception("Missing NOTAM ID");
        if (location == null || location.isEmpty()) throw new Exception("Missing Location (Field A)");
        if (validFrom == null) throw new Exception("Missing Valid From (Field B)");
    }
}

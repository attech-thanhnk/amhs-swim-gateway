...
public class UriConstants {
	...
	// public static final String GLOBAL_SCHEMAS_LOCATION_V3 = "http://icao.int/iwxxm/3.0 http://schemas.wmo.int/iwxxm/3.0/iwxxm.xsd";
        public static final String SCHEMA_LOCATION_OF_BULLETIN_COLLECTION = "http://def.wmo.int/collect/2014 http://schemas.wmo.int/collect/1.2/collect.xsd";
        public static final String SCHEMA_LOCATION_OF_SINGLE = "http://icao.int/iwxxm/2023-1 http://schemas.wmo.int/iwxxm/2023-1/iwxxm.xsd";

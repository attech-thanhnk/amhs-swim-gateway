...
/**
 * Parser cho bản tin NOTAM theo chuẩn ICAO Annex 15.
 *
 * Format chuẩn của NOTAM tại Việt Nam:
 * <pre>
 * (A0001/26 NOTAMN
 * Q) VVHM/QMRLT/IV/NBO/A/000/999/1059N10645E005
 * A) VVNB
 * B) 2601010000
 * C) 2602012359
 * E) RWY 11L/29R CLSD DUE MAINT WIP.)
 * </pre>
 *
 * Sửa lỗi:
 * - E) regex cũ dùng lookahead [FG]\\) bắt buộc, nhưng ~80% NOTAM không có F)/G).
 * - Thêm fallback khi không có F)/G).
 * - Hỗ trợ C) với giá trị EST và PERM.
 */

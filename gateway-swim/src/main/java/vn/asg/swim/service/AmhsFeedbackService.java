 ...
 *   <li><b>CTSW015</b> (§4.4.7.1) — RN không có điện văn gốc: sinh NDR lạc tuyến.</li>
 * </ul>
...
public class AmhsFeedbackService {
    ...
    private void handleMisroutedIpn(AmhsFeedback feedback) {
        ...
        // NDR đi qua hàng đợi gwout_report, mà gwout_report.gwout_id có khoá ngoại trỏ về
        // gwout(msgid). Nên phải ghi THẬT một dòng gwout cho sự kiện này, nếu không INSERT vi phạm
        // khoá ngoại và NDR của CTSW015 mất im lặng.
        //
        // Dòng placeholder nằm ở gwout CHỈ VÌ hàng đợi phát NDR gắn khoá ngoại vào đó - không liên
        // quan tới việc tra điện văn gốc, việc đó dùng gwin cho đúng chiều.
        ...
        placeholder.setOrigin(feedback.getOrigin());
        placeholder.setAddress(feedback.getOrigin());
        ...
        reportService.recordNdr(placeholder.getMsgid(), feedback.getSubjectMts(), feedback.getOrigin(),
        ...
        conversionService.logAmhsToSwim(placeholder, null, "REJECTED",
                "ndr_misrouted_ipn: " + feedback.getIpnType() + " ipmId=" + feedback.getSubjectIpm(),
                feedback.getSubjectMts(), feedback.getSubjectIpm(),
                "invalid-arguments", "unable to notify RN to SWIM due to misrouted RN");
    }

...
--
-- Table structure for table `error_statistics`
--
...
CREATE TABLE `error_statistics` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_time_error` (`stat_time`,`error_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `gateway_statistics_minute`
--

DROP TABLE IF EXISTS `gateway_statistics_minute`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `gateway_statistics_minute` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `stat_time` datetime NOT NULL,
  `total_messages` int DEFAULT '0',
  `success_messages` int DEFAULT '0',
  `failed_messages` int DEFAULT '0',
  `amhs_to_swim_count` int DEFAULT '0',
  `swim_to_amhs_count` int DEFAULT '0',
  `avg_processing_ms` int DEFAULT '0',
  `max_processing_ms` int DEFAULT '0',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
CREATE TABLE `message_conversion_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT 'ID nhật ký chuyển đổi',
  `reference_id` bigint DEFAULT NULL COMMENT 'Tham chiếu tới msgid của bảng gwin/gwout tương ứng',
...
CREATE TABLE `message_log` (
  ...
  `target_system` varchar(10) DEFAULT NULL,
  `routing_rule_id` int DEFAULT NULL,
  `routing_result` varchar(30) DEFAULT NULL,
  `amhs_message_type` varchar(20) DEFAULT NULL,
  `amhs_priority` varchar(5) DEFAULT NULL,
  `originator` varchar(8) DEFAULT NULL,
  `recipients` text,
  `swim_topic` varchar(100) DEFAULT NULL,
  `swim_priority` int DEFAULT NULL,
  `content_type` varchar(20) DEFAULT NULL,
  `processing_status` varchar(20) DEFAULT NULL,
  `processing_step` varchar(30) DEFAULT NULL,
...
--
-- Table structure for table `message_type_statistics`
--
...
CREATE TABLE `message_type_statistics` (
  ...
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_time_type` (`stat_time`,`message_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `routing_statistics`
--

DROP TABLE IF EXISTS `routing_statistics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `routing_statistics` (
  ...
  `failed_count` int DEFAULT '0',
  `no_route_count` int DEFAULT '0',
  `created_at` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `idx_time_rule` (`stat_time`,`routing_rule_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-06-22 10:15:02
